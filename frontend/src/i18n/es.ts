export default {
  ...
  room: {
    ...
    weeklyInfo: 'Selecciona uno o varios dias, luego arrastra sobre la cuadricula para pintar las horas en que estas libre. El mismo patron se aplica a todos los dias seleccionados.',
