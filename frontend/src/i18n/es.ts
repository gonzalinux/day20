export default {
  ...
  roomLogin: {
    ...
    nameTooShort: 'El nombre de la sala debe tener al menos 3 caracteres',
    nameTooLong: 'El nombre de la sala no puede superar los 100 caracteres',
    nameInvalidChars: 'El nombre solo puede contener letras, números y espacios',
  ...
  room: {
    ...
    extendRoom: 'Extender vida de la sala',
    extendRoomHint: 'Reiniciar el temporizador de expiración de 30 días',
    extendRoomDone: '¡Vida de la sala extendida!',
    ...
    confirm: 'Confirmar',
    edit: 'Editar',
    editUser: 'Editar a {name}',
    removeUser: 'Eliminar usuario',
    removeUserConfirm: '¿Eliminar a {name} del grupo? Esta acción no se puede deshacer.',
    newName: 'Nuevo nombre',
    rename: 'Renombrar',
    makeAdmin: 'Hacer admin',
    makeAdminConfirm: '¿Dar poderes de admin a {name}? Debe tener un PIN.',
    removeAdmin: 'Quitar admin',
    removeAdminConfirm: '¿Quitar los poderes de admin a {name}?',
    makeAdminRequiresPin: 'El usuario debe tener un PIN para ser admin',
  },
  feedback: {
    buttonLabel: 'Enviar comentarios',
    title: 'Comentarios y sugerencias',
    message: 'Tu mensaje',
    messagePlaceholder: 'Cuéntanos qué piensas...',
    messageHint: 'Al menos 10 caracteres',
  ...
  home: {
    ...
    faq: '¿Tienes dudas?',
    faq1q: '¿Es gratis?',
    faq1a: 'Completamente gratis. Sin cuenta, sin suscripción, sin límites.',
